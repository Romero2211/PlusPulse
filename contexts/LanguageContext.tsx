...
const translations: Record<Language, Record<string, string>> = {
  uk: {
    ...
    'register.success': 'Обліковий запис створено. Незабаром тут з’явиться вхід у кабінет.',
  ...
  en: {
    ...
    'register.success': 'Your account has been created. Sign-in will be available here soon.',
